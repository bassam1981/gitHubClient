...
public class GitHubIssuesClient {
     ...
     */
    public static List<com.gitHubClient.domain.Issue> getIssues(String... repoIds){
        List<com.gitHubClient.domain.Issue> issues = new ArrayList<>();
        ...
        for (String repo:repoIds){
            try {
                ...
                for (Issue x: list){
                    issues.add(
                            new com.gitHubClient.domain.Issue(
                                    x.getId(),
                                    x.getState(),
                                    x.getTitle(),
                                    repo,
